	...
	<header>
	   ...
	   <section class="home">
            ...
            <div class="content active">
                ...
                <p>Scopri la bellezza mozzafiato della Croazia: mare cristallino, città storiche e isole incontaminate ti aspettano!</p>
                <a href="/accesso/pacchettiOfferte">Prenota ora</a>
            </div>
            <!--COPENHAGEN-->
            <div class="content">
                <h1><strong><br><span>COPENHAGEN</span></strong></h1>
                <p>Esplora la città più felice del mondo: Copenhagen ti incanterà con la sua architettura iconica, i canali pittoreschi, la cultura del design e la cucina nordica raffinata.</p>
                <a href="/accesso/pacchettiOfferte">Prenota ora</a>
            </div>
            <!-- TENERIFE-->
            <div class="content">
                <h1><strong><br><span>TENERIFE</span></strong></h1>
                <p>Tuffati nell'isola dell'eterna primavera: Tenerife ti sorprenderà con le sue spiagge dorate, i vulcani maestosi e la natura spettacolare. Un paradiso tropicale tutto da scoprire!</p>
                <a href="/accesso/pacchettiOfferte">Prenota ora</a>
            </div>
